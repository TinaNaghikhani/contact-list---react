    ...
    <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-4 rounded-lg ">
        <div className="top-0 flex justify-between">
          <h2 className="font-semibold">حذف کاربر</h2>
          <button className="font-bold" onClick={onClose}>x</button>
        </div>
        <p className="m-8">از حذف کردن این مخاطب مطمئن هستید؟</p>
        <button className="rounded mx-1 px-1 bg-green-500 text-white font-bold">بله</button>
